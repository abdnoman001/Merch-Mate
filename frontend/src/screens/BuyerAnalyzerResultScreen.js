...
const BuyerAnalyzerResultScreen = ({ route, navigation }) => {
    ...
    const handleShareText = async () => {
        const message = `📊 *MARGIN ANALYSIS REPORT*

*Style:* ${inputs.styleName || 'N/A'}
*Buyer:* ${inputs.buyerName || 'N/A'}

*PRICING:*
• Buyer Target: ${currencySymbol}${analysis.inputs.buyerTargetFob.toFixed(2)}
• Your Quote: ${currencySymbol}${analysis.inputs.quotedFob.toFixed(2)}
• Price Gap: ${currencySymbol}${analysis.priceGap.toFixed(2)} (${analysis.priceGapPercent.toFixed(1)}%)

*COST BREAKDOWN:*
• Total Cost: ${currencySymbol}${analysis.totalCost.toFixed(2)}/pc
• Break-even FOB: ${currencySymbol}${analysis.breakEvenFob.toFixed(2)}

*MARGIN ANALYSIS:*
• Gross Margin: ${currencySymbol}${analysis.grossMargin.toFixed(2)}/pc
• Margin %: ${analysis.marginPercent.toFixed(1)}%
• Status: ${getMarginStatusLabel(analysis.marginPercent)}

*FEASIBILITY:*
• Score: ${analysis.feasibilityScore.score}/100
• Status: ${analysis.feasibilityScore.status}
• Recommendation: ${analysis.feasibilityScore.recommendation}

*ORDER VALUE:*
• Quantity: ${analysis.inputs.orderQuantity.toLocaleString()} pcs
• Total Value: ${currencySymbol}${analysis.totalOrderValue.toLocaleString()}
• Expected Profit: ${currencySymbol}${analysis.totalProfit.toLocaleString()}
...
_Generated by MerchMate_`;
    ...
    const handleShareExcel = async () => {
        try {
            const data = buildMarginAnalysisData(inputs, analysis);
            ...
            <View style={styles.card}>
                ...
                <View style={[
                    ...
                    <Text style={styles.varianceText}>
                        {analysis.isViable
                            ? `✓ Buyer target is ${currencySymbol}${analysis.targetVariance.toFixed(2)} above your required FOB`
                            : `✗ Buyer target is ${currencySymbol}${Math.abs(analysis.targetVariance).toFixed(2)} below your required FOB`
                        }
                    </Text>
                </View>
            </View>
        ...
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.styleHeader}>
                ...
                <View style={styles.incoTermBadge}>
                    <Text style={styles.incoTermText}>{inputs.incoterm} • {inputs.currency}</Text>
                </View>
            </View>
