...
• Fabric: $${breakdown.fabric_cost_per_pc?.toFixed(2) || '0.00'}
• AOP/Print: $${inputs.aop_print_cost_per_pc || '0.00'}
• Accessories: $${inputs.accessories_cost_per_pc || '0.00'}
• CM Cost: $${inputs.cm_cost_per_pc || '0.00'}
• Washing: $${inputs.washing_cost_per_pc || '0.00'}
• Commercial: $${inputs.commercial_cost_per_pc || '0.00'}
• Testing: $${inputs.testing_cost_per_pc || '0.00'}

*Total Cost:* $${breakdown.total_cost_per_pc?.toFixed(2)}/pc
*Profit Margin:* ${profitMargin}%

*FINAL FOB PRICE: $${finalFob.toFixed(2)}/pc* ✅
    ...
    return (
        <ScrollView style={styles.container}>
            ...
            <View style={styles.actionsRow}>
                <TouchableOpacity style={[styles.shareButton, { backgroundColor: '#10b981' }]} onPress={handleShareExcel}>
                    <Text style={styles.shareText}>Share Excel</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.shareButton, { backgroundColor: '#ef4444' }]} onPress={handleSharePdf}>
                    <Text style={styles.shareText}>Share/Download PDF</Text>
                </TouchableOpacity>
            </View>

            <TouchableOpacity style={[styles.shareButton, { backgroundColor: '#007bff' }]} onPress={handleShare}>
...
const styles = StyleSheet.create({
    ...
    actionsRow: { flexDirection: 'row', gap: 12, justifyContent: 'space-between', marginBottom: 20 },
});
