...
const ResultScreen = ({ route }) => {
    ...
    const handleShare = async () => {
        ...
        const message = `📊 *FOB COSTING QUOTE*
...
• Fabric: $${(breakdown.fabric_cost_per_doz || (breakdown.fabric_cost_per_pc * 12))?.toFixed(2) || '0.00'}
• AOP/Print: $${((inputs.aop_print_cost_per_pc || 0) * 12).toFixed(2)}
• Accessories: $${((inputs.accessories_cost_per_pc || 0) * 12).toFixed(2)}
• CM Cost: $${((inputs.cm_cost_per_pc || 0) * 12).toFixed(2)}
• Washing: $${((inputs.washing_cost_per_pc || 0) * 12).toFixed(2)}
• Commercial: $${((inputs.commercial_cost_per_pc || 0) * 12).toFixed(2)}
• Testing: $${((inputs.testing_cost_per_pc || 0) * 12).toFixed(2)}
...
*FINAL FOB PRICE: $${finalFob.toFixed(2)}/dz ($${(finalFob / 12).toFixed(2)}/pc)* ✅
    ...
    return (
        <ScrollView style={styles.container}>
            <View style={styles.headerCard}>
                ...
                <Text style={styles.price}>$ {finalFob.toFixed(2)} <Text style={styles.unit}>/ dz</Text></Text>
                <Text style={styles.perPieceText}>$ {(finalFob / 12).toFixed(2)} / pc</Text>
            </View>
            ...
            <View style={styles.section}>
                <Text style={styles.sectionTitle}>Cost Breakdown (per Dozen)</Text>
                <View style={styles.tableRow}>
                    <Text style={styles.tableLabel}>Fabric Cost</Text>
                    <Text style={styles.tableValue}>$ {(breakdown.fabric_cost_per_doz || (breakdown.fabric_cost_per_pc * 12))?.toFixed(2) || '0.00'}</Text>
                </View>
                <View style={styles.tableRow}>
                    <Text style={styles.tableLabel}>Print/AOP</Text>
                    <Text style={styles.tableValue}>$ {((inputs.aop_print_cost_per_pc || 0) * 12).toFixed(2)}</Text>
                </View>
                <View style={styles.tableRow}>
                    <Text style={styles.tableLabel}>Accessories</Text>
                    <Text style={styles.tableValue}>$ {((inputs.accessories_cost_per_pc || 0) * 12).toFixed(2)}</Text>
                </View>
                <View style={styles.tableRow}>
                    <Text style={styles.tableLabel}>CM Cost</Text>
                    <Text style={styles.tableValue}>$ {((inputs.cm_cost_per_pc || 0) * 12).toFixed(2)}</Text>
                </View>
                <View style={styles.tableRow}>
                    <Text style={styles.tableLabel}>Washing</Text>
                    <Text style={styles.tableValue}>$ {((inputs.washing_cost_per_pc || 0) * 12).toFixed(2)}</Text>
                </View>
                <View style={styles.tableRow}>
                    <Text style={styles.tableLabel}>Commercial</Text>
                    <Text style={styles.tableValue}>$ {((inputs.commercial_cost_per_pc || 0) * 12).toFixed(2)}</Text>
                </View>
                <View style={styles.tableRow}>
                    <Text style={styles.tableLabel}>Testing</Text>
                    <Text style={styles.tableValue}>$ {((inputs.testing_cost_per_pc || 0) * 12).toFixed(2)}</Text>
                </View>
                <View style={[styles.tableRow, { borderTopWidth: 1, marginTop: 5, paddingTop: 5 }]}>
                    ...
                    <Text style={[styles.tableValue, { fontWeight: 'bold' }]}>$ {(breakdown.total_cost_per_doz || (breakdown.total_cost_per_pc * 12))?.toFixed(2) || '0.00'}</Text>
                </View>
            </View>
            ...
            <View style={styles.actionsRow}>
                <TouchableOpacity style={[styles.actionButton, { backgroundColor: '#10b981' }]} onPress={handleShareExcel}>
                    <Text style={styles.iconEmoji}>📊</Text>
                    <Text style={styles.actionText}>Excel</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.actionButton, { backgroundColor: '#ef4444' }]} onPress={handleSharePdf}>
                    <Text style={styles.iconEmoji}>📄</Text>
                    <Text style={styles.actionText}>PDF</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.actionButton, { backgroundColor: '#007bff' }]} onPress={handleShare}>
                    <Text style={styles.iconEmoji}>💬</Text>
...
const styles = StyleSheet.create({
    ...
    unit: { fontSize: 20 },
    perPieceText: { color: 'rgba(255,255,255,0.9)', fontSize: 18, marginTop: 5 },
    ...
    shareButton: { backgroundColor: '#007bff', padding: 15, borderRadius: 10, alignItems: 'center', marginBottom: 30 },
